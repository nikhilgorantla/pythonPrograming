...
# Data:         14/Jan/2018
# Description:  This program uses the hashing to find the duplicate file and delete. 
...
fPath = input("please enter the dir full path: ")
for rootdir, dirs, files in os.walk(fPath):
    for f in files:
