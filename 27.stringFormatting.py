...
# Data:         14/Jan/2018
# Description:  This is a fun python program of implementation of python string formatting 
...
age = int(input("Enter your age: "))  # String to Integer conversion by default the input is in string formate 
